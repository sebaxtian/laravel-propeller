	...
	<div class="container-fluid"> 
		...
		<section class="row component-section">	
			...
			<div class="col-md-3 col-sm-12">
				...
				<p>Add <a href="dropdown.html" target="_blank">Propeller's Dropdown menu</a> to make it a part of tab. To do so create a drop down list within the tablist and add <code>.dropdown-menu</code> to it.</p>
