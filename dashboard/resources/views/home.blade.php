			...
			<div class="pmd-card pmd-z-depth">      
				<div class="pmd-card-title">
					...
					<div class="media-body media-middle">
						<h2 class="pmd-card-title-text typo-fill-secondary">Recent Activities<span class="grow-up"><img src="{{ asset('pmd/themes/images/grow-up-arrow.png') }}" alt="grow-up"></span></h2>
					</div>
...
<!--circle chart-->
<script src="{{ asset('pmd/themes/js/circles.min.js') }}"></script>
<!--staked column chart for payment-->
<script src="{{ asset('pmd/themes/js/highcharts.js') }}"></script>
<script src="{{ asset('pmd/themes/js/highcharts-more.js') }}"></script>
