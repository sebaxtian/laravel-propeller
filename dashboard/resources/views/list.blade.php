						...
						<div class="row">
							<div class="col-md-6">
								<ul class="list-group pmd-z-depth pmd-card-list pmd-list-avatar">
									<li class="list-group-item">
										<div class="media-left"> <a href="javascript:void(0);" class="avatar-list-img"> <img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="{{ asset('pmd/components/list/img/40x40.png') }}" data-holder-rendered="true"> </a> </div>
							...
							<div class="col-md-6">
								<ul class="list-group pmd-z-depth pmd-card-list pmd-list-avatar">
									<li class="list-group-item">
										<div class="media-left"> <a class="avatar-list-img" href="javascript:void(0);"> <img data-holder-rendered="true" src="{{ asset('pmd/components/list/img/40x40.png') }}" class="img-responsive" data-src="holder.js/40x40" alt="40x40"> </a> </div>
					...
					<div class="component-box">
						...
						<div class="row">
							...
							<div class="col-md-4"> 
								...
								<ul class="list-group pmd-z-depth pmd-list pmd-card-list">
									<li class="list-group-item">
										<div class="media-left"> <a class="avatar-list-img avatar-list-img-custom" href="javascript:void(0);"> <img data-holder-rendered="true" src="{{ asset('pmd/components/list/img/40x40.png') }}" class="img-responsive" data-src="holder.js/40x40" alt="40x40"> </a> </div>
